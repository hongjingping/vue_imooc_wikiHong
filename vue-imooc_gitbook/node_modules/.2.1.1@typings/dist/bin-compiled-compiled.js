...
emitter.on('hastypings', function (_a) {
    var name = _a.name,
        typings = _a.typings;
    cli_1.logWarning("Typings for \"" + name + "\" already exist in \"" + path_1.relative(cwd, typings) + "\". You should " + "let TypeScript resolve the packaged typings and uninstall the copy installed by Typings", 'hastypings');
});
...
//# sourceMappingURL=bin-compiled-compiled.js.map